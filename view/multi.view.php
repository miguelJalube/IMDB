    ...
    if(!isset($data) || $data == null){
        ...
        foreach($data[0] as $v){
            if($v->getMedia_type() == 'movie' || $v->getMedia_type() == 'Film'){
                ...
                $header = $v->getName();
                $image = '<div class="card-image"><img style="width:185px;height:278px;" alt="'.$v->getName().'" src="http://image.tmdb.org/t/p/w185'.$v->getProfile_path().'"/></div>';
                ...
                $header = $v->getName();
                $image = '<div class="card-image"><img style="width:185px;height:278px;" alt="'.$v->getName().'" src="http://image.tmdb.org/t/p/w185'.$v->getPoster_path().'"/></div>';
